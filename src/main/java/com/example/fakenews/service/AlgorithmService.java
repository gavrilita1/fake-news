...
public class AlgorithmService {
    ...
    public AlgorithmService algorithmRun(Status status, UsersResources user, Long userId, String url) throws TwitterException {
        ...
        checkUpdateHistory((int) id, run, userId, url);
    ...
    public void checkUpdateHistory(int id, AlgorithmService run, Long userId, String url) {
        Check check = new Check(userId, id, run.score, run.reason.toString(), url);
